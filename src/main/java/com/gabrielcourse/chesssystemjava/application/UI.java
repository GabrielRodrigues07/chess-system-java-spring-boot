...
public class UI {
    ...
    private static void printCapturedPieces(List<ChessPiece> captured) {
        List<ChessPiece> white = captured.stream().filter(x -> Color.WHITE.equals(x.getColor())).collect(Collectors.toList());
        List<ChessPiece> black = captured.stream().filter(x -> Color.BLACK.equals(x.getColor())).collect(Collectors.toList());
